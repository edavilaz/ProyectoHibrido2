...
@dso_cache = dso_local local_unnamed_addr global [592 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1139152491, ; hash 0x43e6166b, from name: ProyectoHibrido2.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1957798513, ; hash 0x74b1a271, from name: aot-ProyectoHibrido2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ProyectoHibrido2.dll.so
		ptr null; void* handle (0x0)
	}, ; 251
	...
	%struct.DSOCacheEntry {
		i64 1984492361, ; hash 0x7648f349, from name: libaot-ProyectoHibrido2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ProyectoHibrido2.dll.so
		ptr null; void* handle (0x0)
	}, ; 258
	...
	%struct.DSOCacheEntry {
		i64 2904662198, ; hash 0xad21a0b6, from name: libaot-ProyectoHibrido2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ProyectoHibrido2.dll.so
		ptr null; void* handle (0x0)
	}, ; 400
	...
	%struct.DSOCacheEntry {
		i64 3781692046, ; hash 0xe1680a8e, from name: ProyectoHibrido2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ProyectoHibrido2.dll.so
		ptr null; void* handle (0x0)
	}, ; 520
	...
	%struct.DSOCacheEntry {
		i64 4010464116, ; hash 0xef0ad374, from name: aot-ProyectoHibrido2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ProyectoHibrido2.dll.so
		ptr null; void* handle (0x0)
	}, ; 554
